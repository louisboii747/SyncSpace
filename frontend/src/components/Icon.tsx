...
export type IconName = 'home' | 'settings' | 'send' | 'devices' | 'history' | 'diagnostics' | 'plus' | 'folder' | 'file' | 'pause' | 'play' | 'close' | 'retry' | 'check' | 'copy' | 'shield' | 'refresh' | 'bell' | 'arrowUp' | 'arrowDown' | 'wifi' | 'more'
